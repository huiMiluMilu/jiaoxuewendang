...
- 历史视频产物总索引：
  [VIDEO_RUNS_INDEX.md](VIDEO_RUNS_INDEX.md)
- 一键安装脚本：
...
- 如果课程偏讲解、方法论、概念拆解，不用 `步骤1`、`步骤2`
- 这类文档主标题改用 `一、`、`二、`、`三、`
- 如果是在某个大标题下面继续展开，再用 `1、`、`2、`、`3、`
- 只有真正的操作演示步骤，才使用 `步骤1`、`步骤2`
...
1. 每个新视频单独创建一个文件夹
2. 文件夹名称尽量使用课程标题或视频主题
3. 最终文档放在该目录下
4. 中间产物放在该目录下的 `work/`

这样在确认文档可用后，直接删除该视频对应的整个目录，就能一起清掉中间产物。
